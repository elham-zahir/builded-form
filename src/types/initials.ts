...
export const inputTypes: IOptionType[] = [
  ...
  { name: "عدد بدون دکمه ی کم و زیاد", value: "numberWithoutButton" },
];
...
const initialLocationFields: IFieldType[] = [
  {
    label: "استان",
    name: "province",
    type: { name: "سلکشن", value: "select" },
...
const initialbusinessFields: IFieldType[] = [
  {
    label: "نام فارسی کسب و کار",
    name: "persianNameOfBusiness",
    type: { name: "متن کوتاه", value: "text" },
    required: true,
    min: 2,
    max: 80,
  ...
  {
    label: "نام انگلیسی کسب و کار",
    name: "englishNameOfBusiness",
    type: { name: "متن کوتاه", value: "text" },
    required: true,
    min: 2,
    max: 80,
  ...
  },
  {
    ...
    id: 6,
    options: [
      { name: "تجاری", value: "commercial" },
      { name: "غیر تجاری", value: "non-commercial" },
    ],
    min: undefined,
    max: undefined,
    category: "businessInfo",
  },
  {
    ...
    id: 6,
    options: [
      { name: "صنفی", value: "guild" },
      { name: "غیر صنفی", value: "non-guild" },
    ],
    min: undefined,
    max: undefined,
    category: "businessInfo",
...
const initialBusinessContactFields: IFieldType[] = [
  {
    label: "تلفن ثابت",
    ...
    min: undefined,
    max: undefined,
    category: "businessContactInfo",
  },
];

export const formCategories: FormCategories = {
  personFields: initialPersonFields,
  personLocationField: initialLocationFields,
  contactInfoFields: initialContactFields,
  businessInfoFields: initialbusinessFields,
  businessContactFields: initialBusinessContactFields,
};
